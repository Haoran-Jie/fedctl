...
def test_create_experiment_logger_uses_run_config_and_env(monkeypatch) -> None:
    ...
    monkeypatch.setenv(
        "FEDCTL_RUN_CONFIG",
        "apps/fedctl_research/run_configs/compute_heterogeneity/main/cifar10_cnn/iid/fedrolex.toml",
    )
...
def test_wandb_experiment_logger_logs_and_finishes(monkeypatch) -> None:
    ...
    monkeypatch.setenv(
        "FEDCTL_RUN_CONFIG",
        "apps/fedctl_research/run_configs/compute_heterogeneity/main/fashion_mnist_cnn/heterofl.toml",
    )
...
def test_wandb_retry_attempts_keep_same_canonical_key_and_name(monkeypatch) -> None:
    ...
    monkeypatch.setenv(
        "FEDCTL_RUN_CONFIG",
        "apps/fedctl_research/run_configs/network_heterogeneity/main/cifar10_cnn/noniid/mixed/fedbuff.toml",
    )
    monkeypatch.setenv("FEDCTL_REPO_CONFIG_LABEL", "none")
...
def test_create_experiment_logger_tolerates_flower_mapping_missing_optional_keys(monkeypatch) -> None:
    ...
    monkeypatch.setenv(
        "FEDCTL_RUN_CONFIG",
        "apps/fedctl_research/run_configs/network_heterogeneity/main/cifar10_cnn/iid/mixed/fedavg.toml",
    )
    monkeypatch.setenv("FEDCTL_REPO_CONFIG_LABEL", "none")
