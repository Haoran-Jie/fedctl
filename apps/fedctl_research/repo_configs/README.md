...
- `network_heterogeneity/main/low_concurrency/none.yaml`: 20-node asynchronous main-study profile paired with `experiment_configs/network_heterogeneity/main/cifar10_cnn/low_concurrency/`.
- `network_heterogeneity/main/high_concurrency/none.yaml`: 50-node packed asynchronous main-study profile paired with `experiment_configs/network_heterogeneity/main/cifar10_cnn/high_concurrency/`.
